...
class Jogo {
    public static void main(String[] args){
        try (Scanner input = new Scanner(System.in)) {
            System.out.println("Matt, Alexander, Tina and Parker heard rummors that a spirit, called ''La Chika'', roams an abandoned school at night and now are going to investigate it further");
